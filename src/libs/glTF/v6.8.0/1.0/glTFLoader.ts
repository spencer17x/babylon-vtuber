...
import type { ISceneLoaderAsyncResult, ISceneLoaderProgressEvent } from "@babylonjs/core/Loading/sceneLoader";
...
class Tokenizer {
    ...
    public isLetterOrDigitPattern = /^[a-zA-Z0-9]+$/;
 ...
 * @param newSkeleton
 */
const importSkeleton = (gltfRuntime: IGLTFRuntime, skins: IGLTFSkins, _mesh: Mesh, newSkeleton: Skeleton | undefined): Skeleton => {
    if (!newSkeleton) {
 ...
 * @param meshIncluded
 */
const traverseNodes = (gltfRuntime: IGLTFRuntime, id: string, parent: Nullable<Node>, meshIncluded = false) => {
...
const onShaderCompileError = (program: IGLTFProgram, shaderMaterial: ShaderMaterial, onError: (message: string) => void) => {
    return (_effect: Effect, error: string) => {
...
export abstract class GLTFLoaderExtension {
     ...
     * @param onError
     */
    public loadRuntimeAsync(_scene: Scene, _data: IGLTFLoaderData, _rootUrl: string, _onSuccess?: (gltfRuntime: IGLTFRuntime) => void, _onError?: (message: string) => void): boolean {
        return false;
    }
     ...
     * @param onError
     */
    public loadRuntimeExtensionsAsync(_gltfRuntime: IGLTFRuntime, _onSuccess: () => void, _onError?: (message: string) => void): boolean {
        return false;
    }
    ...
    public loadBufferAsync(
        _gltfRuntime: IGLTFRuntime,
        _id: string,
        _onSuccess: (buffer: ArrayBufferView) => void,
     ...
     * @param onError
     */
    public loadTextureBufferAsync(_gltfRuntime: IGLTFRuntime, _id: string, _onSuccess: (buffer: ArrayBufferView) => void, _onError: (message: string) => void): boolean {
        return false;
    }
     ...
     * @param _onError
     */
    public createTextureAsync(_gltfRuntime: IGLTFRuntime, _id: string, _buffer: ArrayBufferView, _onSuccess: (texture: Texture) => void, _onError: (message: string) => void): boolean {
        return false;
    }
     ...
     * @param onError
     */
    public loadShaderStringAsync(_gltfRuntime: IGLTFRuntime, _id: string, _onSuccess: (shaderString: string) => void, _onError: (message: string) => void): boolean {
        return false;
    }
     ...
     * @param _onError
     */
    public loadMaterialAsync(_gltfRuntime: IGLTFRuntime, _id: string, _onSuccess: (material: Material) => void, _onError: (message: string) => void): boolean {
        return false;
    }
