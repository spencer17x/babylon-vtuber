...
export const enum AnimationSamplerInterpolation {
	...
	LINEAR = "LINEAR",
	/**
	 * The animated values remain export constant to the output of the first keyframe, until the next keyframe
	 */
	STEP = "STEP",
	/**
 ...
 */
export interface IGLTFValidationOptions {
	/** Uri to use */
	uri?: string;
 ...
 * @internal
 */
export interface IGLTFValidator {
...
/**
 * export interfaces from the EXT_lights_image_based extension
 */

/** @internal */
export interface IEXTLightsImageBased_LightReferenceImageBased {
	light: number;
}

/** @internal */
export interface IEXTLightsImageBased_LightImageBased extends IChildRootProperty {
	intensity: number;
	rotation: number[];
...
/** @internal */
export interface IEXTLightsImageBased {
	lights: IEXTLightsImageBased_LightImageBased[];
}

/**
 * export interfaces from the EXT_mesh_gpu_instancing extension
...
/**
 * export interfaces from the KHR_draco_mesh_compression extension
 */
...
/**
 * export interfaces from the KHR_lights_punctual extension
 */
...
/** @internal */
export interface IKHRLightsPunctual_Light extends IChildRootProperty {
...
/** @internal */
export interface IMaterialExtension {
	hasTextures?(): boolean;
}

/** @internal */
export interface IKHRMaterialsClearcoat extends IMaterialExtension {
...
/** @internal */
export interface IKHRMaterialsIridescence extends IMaterialExtension {
...
/** @internal */
export interface IKHRMaterialsAnisotropy extends IMaterialExtension {
...
/**
 * export interfaces from the KHR_materials_ior extension
 */

/** @internal */
export interface IKHRMaterialsIor extends IMaterialExtension {
	ior?: number;
}

/**
 * export interfaces from the KHR_materials_volume extension
 */

/** @internal */
export interface IKHRMaterialsVolume extends IMaterialExtension {
...
/**
 * export interfaces from the KHR_materials_specular extension
 */

/** @internal */
export interface IKHRMaterialsSpecular extends IMaterialExtension {
...
/**
 * export interfaces from the KHR_materials_transmission extension
 */

/** @internal */
export interface IKHRMaterialsTransmission extends IMaterialExtension {
	transmissionFactor?: number;
	transmissionTexture?: ITextureInfo;
}

/**
 * export interfaces from the KHR_materials_emissive_strength extension
 */

/** @internal */
export interface IKHRMaterialsEmissiveStrength extends IMaterialExtension {
	emissiveStrength: number;
}

/**
 * export interfaces from the KHR_materials_pbrSpecularGlossiness extension
 */

/** @internal */
export interface IKHRMaterialsPbrSpecularGlossiness extends IMaterialExtension {
...
/**
 * export interfaces from the KHR_materials_sheen extension
 */

/** @internal */
export interface IKHRMaterialsSheen extends IMaterialExtension {
...
/**
 * export interfaces from the KHR_materials_translucency extension
 * !!! Experimental Extension Subject to Changes !!!
 */

/** @internal */
export interface IKHRMaterialsTranslucency extends IMaterialExtension {
	translucencyFactor?: number;
	translucencyTexture?: ITextureInfo;
}

/**
 * export interfaces from the KHR_materials_variants extension
 */

/** @internal */
export interface IKHRMaterialVariants_Mapping extends IProperty {
	mappings: Array<{
		variants: number[];
		material: number;
	}>;
...
/** @internal */
export interface IKHRMaterialVariants_Variant extends IProperty {
	name: string;
}

/** @internal */
export interface IKHRMaterialVariants_Variants extends IChildRootProperty {
	variants: Array<IKHRMaterialVariants_Variant>;
}

/**
 * export interfaces from the KHR_texture_basisu extension
 */
...
/**
 * export interfaces from the EXT_texture_webp extension
 */
...
/**
 * export interfaces from the KHR_texture_transform extension
 */
...
/**
 * export interfaces from the KHR_xmp_json_ld extension
 */

/** @internal */
export interface IKHRXmpJsonLd_Gltf {
	packets: Array<{
		[key: string]: unknown;
	}>;
}
...
/** @internal */
export interface IKHRXmpJsonLd_Node {
	packet: number;
}

/**
 * export interfaces from the KHR_animation_pointer extension
 * !!! Experimental Extension Subject to Changes !!!
 */
...
/**
 * export interfaces from the MSFT_audio_emitter extension
 */
...
/** @internal */
export interface IMSFTAudioEmitter_EmittersReference {
	emitters: number[];
}
...
/** @internal */
export interface IMSFTAudioEmitter_Emitter {
	name?: string;
...
/** @internal */
export interface IMSFTAudioEmitter_Clip extends IProperty {
	uri?: string;
	bufferView?: number;
...
/** @internal */
export interface IMSFTAudioEmitter_AnimationEvent {
...
/**
 * export interfaces from the MSFT_lod extension
 */
...
/**
 * export interfaces from the EXT_meshopt_compression extension
 */
