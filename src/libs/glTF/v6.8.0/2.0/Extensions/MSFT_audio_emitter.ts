...
import type { IMSFTAudioEmitter_Clip, IMSFTAudioEmitter_Emitter, IMSFTAudioEmitter_EmittersReference, IMSFTAudioEmitter_AnimationEvent } from "../../glTF2Interface";
import { IMSFTAudioEmitter_AnimationEventAction } from "../../glTF2Interface";
...
export class MSFT_audio_emitter implements IGLTFLoaderExtension {
    ...
    private _loadEmitterAsync(_context: string, emitter: ILoaderEmitter): Promise<void> {
    ...
    private _loadAnimationEventAsync(
        context: string,
        _animationContext: string,
        _animation: IAnimation,
