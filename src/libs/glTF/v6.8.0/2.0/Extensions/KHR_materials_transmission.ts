...
import type { IKHRMaterialsTransmission } from "../../glTF2Interface";
...
export class KHR_materials_transmission implements IGLTFLoaderExtension {
    ...
    private _loadTransparentPropertiesAsync(context: string, _material: IMaterial, babylonMaterial: Material, extension: IKHRMaterialsTransmission): Promise<void> {
