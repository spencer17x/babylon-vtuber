...
import type { IKHRMaterialsPbrSpecularGlossiness } from "../../glTF2Interface";
...
export class KHR_materials_pbrSpecularGlossiness implements IGLTFLoaderExtension {
    ...
    private _loadSpecularGlossinessPropertiesAsync(context: string, _material: IMaterial, properties: IKHRMaterialsPbrSpecularGlossiness, babylonMaterial: Material): Promise<void> {
