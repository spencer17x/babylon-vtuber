...
import type * as GLTF2 from "./glTF2Interface";
...
import { RuntimeError, ErrorCodes } from "@babylonjs/core/Misc/error";
...
export class GLTFFileLoader implements IDisposable, ISceneLoaderPluginAsync, ISceneLoaderPluginFactory {
    ...
    public loadFile(
        ...
        this._progressCallback = onProgress;
				...
				// rootUrl = (fileOrUrl as File).name ? "file:" : Tools.GetFolderPath(fileOrUrl as string);
    ...
    private _parseJson(json: string): Record<string, any> {
    ...
    private _logDisabled(_message: string): void {}
    ...
    private _startPerformanceCounterDisabled(_counterName: string): void {}

    private _endPerformanceCounterEnabled(counterName: string): void {
        Tools.EndPerformanceCounter(counterName);
    }

    private _endPerformanceCounterDisabled(_counterName: string): void {}
}
