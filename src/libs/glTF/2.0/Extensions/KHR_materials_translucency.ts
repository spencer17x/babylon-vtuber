...
import type { IKHRMaterialsTranslucency } from "../../glTF2Interface";
...
export class KHR_materials_translucency implements IGLTFLoaderExtension {
    ...
    private _loadTranslucentPropertiesAsync(context: string, _material: IMaterial, babylonMaterial: Material, extension: IKHRMaterialsTranslucency): Promise<void> {
