...
import type { IKHRMaterialsVolume } from "../../glTF2Interface";
...
export class KHR_materials_volume implements IGLTFLoaderExtension {
    ...
    private _loadVolumePropertiesAsync(context: string, _material: IMaterial, babylonMaterial: Material, extension: IKHRMaterialsVolume): Promise<void> {
