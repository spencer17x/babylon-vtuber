...
import type { IEXTLightsImageBased_LightReferenceImageBased, IEXTLightsImageBased_LightImageBased, IEXTLightsImageBased } from "../../glTF2Interface";
...
interface Internal_IEXTLightsImageBased_LightImageBased extends IEXTLightsImageBased_LightImageBased {
...
export class EXT_lights_image_based implements IGLTFLoaderExtension {
    ...
    private _lights?: Internal_IEXTLightsImageBased_LightImageBased[];
    ...
    private _loadLightAsync(context: string, light: Internal_IEXTLightsImageBased_LightImageBased): Promise<BaseTexture> {
        if (!light._loaded) {
            const promises = new Array<Promise<any>>();
